...
printk(KERN_INFO "Adding all filters from seedFilter...
\n");
...
printk(KERN_INFO "Filters added from seedFilter.\n");
return 0;
}

void removeFilter(void) {
printk(KERN_INFO "Removing all filters from seedFilter...
\n");
